...
public class AdminFacade implements CouponClientFacade{
	 ...
	 */
	@Cacheable (value = "getCompanyCache", key = "#id")
	 ...
	 */
	@Cacheable (value = "getCompanyByNameCache", key = "#name")
	 ...
	 */
	@Cacheable ("getAllCompaniesCache")
	 ...
	 */
	@Cacheable (value = "getCustomerByNameCache", key = "#name")
	 ...
	 */
	@Cacheable ("getAllCustomersCache")
	...
	public CouponClientFacade login(String name, String password) {
		...
		if (name.equals(SystemVariables.adminUserName) && password.equals(SystemVariables.adminPassword))
		{
			transactionDBDAO.createTransaction(transaction);
