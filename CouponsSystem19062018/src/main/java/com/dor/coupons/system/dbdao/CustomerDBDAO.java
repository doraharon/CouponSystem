...
public class CustomerDBDAO implements CustomerDAO {
	 ...
	 *<p>This method get a Synchronize from the Synchronize pool and return it when finished.</p>
	 * @param title Title of the purchased coupon you want to get.
	...
	public Coupon getPurchasedCoupoonById(long couponId)
	{
		Synchronize synchronize = synchronizePool.getSynchronize();
		Coupon coupon = customerRepo.getCouponByidAndCustomerId(ConnectedId, couponId);
		synchronizePool.returnSynchronize(synchronize);
		return coupon;
	}
	/**
