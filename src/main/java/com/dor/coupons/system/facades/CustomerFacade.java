...
public class CustomerFacade implements CouponClientFacade {
	...
	public void purchaseCoupon (Coupon coupon)
	{
		...
		if (couponDBDAO.checkIfPurchasedCoupon(coupon.getTitle(), customer.getId()))
		{
			...
			String message = String.format(ExceptionsMessages.couponAlreadyPurchasedExceptionMessage, coupon);
		...
		if (coupon.getEndDate().before(new Date ()))
		{
			...
			transactionDBDAO.createTransaction(transaction);
			String message = String.format(ExceptionsMessages.couponExpierdExceptionMessage, coupon);
		...
		if(coupon.getAmount()==SystemVariables.zero)
		{
			...
			transactionDBDAO.createTransaction(transaction);
			String message = String.format(ExceptionsMessages.couponOutOfStockExceptionMessage, coupon);
	...
	{
		return customerDBDAO.getPurchasedCoupoonByTitle(title);
	}
	/**
