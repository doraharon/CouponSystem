...
public interface CustomerRepo extends CrudRepository<Customer, Long> {
	...
	@Query("SELECT coupon FROM CUSTOMER CUST INNER JOIN CUST.coupons AS coupon WHERE CUST.id = :customer_id AND coupon.id = :coupon_id")
	Coupon getCouponByidAndCustomerId (@Param ("customer_id")long customer_id , @Param("coupon_id")long id);
}
